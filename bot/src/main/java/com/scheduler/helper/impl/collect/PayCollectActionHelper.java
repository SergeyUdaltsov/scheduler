 ...
 */
public class PayCollectActionHelper implements ICollectActionHelper {

    private IUserService userService;

    public PayCollectActionHelper(IUserService userService) {
    ...
    public CommandType getNextCommandType() {
        return CommandType.COLLECT_PAY_YEAR_SELECT;
    }
