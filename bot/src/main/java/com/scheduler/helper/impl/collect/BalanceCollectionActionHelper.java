 ...
 */
public class BalanceCollectionActionHelper implements ICollectActionHelper {
    private IUserService userService;

    public BalanceCollectionActionHelper(IUserService userService) {
    ...
    public CommandType getNextCommandType() {
        return CommandType.COLLECT_BALANCE_PROCESSOR;
    }
